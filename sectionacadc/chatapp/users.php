    ...
    <header class="header">
     ...
     ?>
        ...
        <div class="nav">
            ...
            <ul class="navigation">
                <li><a id="a" href="http://localhost/sectionacadc/chatapp/acueil.php#acueil"> Acueil</a></li>
                <li><a id="a" href="http://localhost/sectionacadc/chatapp/acueil.php#Modules"> module</a></li>
                <li><a id="a" href="http://localhost/sectionacadc/chatapp/acueil.php#emploi"> Emploi du temp</a></li>
                <li><a id="a" href="http://localhost/sectionacadc/chatapp/acueil.php#lien"> Liens de cours</a></li>
                <li><a id="a" href="http://localhost/sectionacadc/chatapp/sandage.php"> sondage</a></li>
