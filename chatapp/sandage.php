    ...
    <div>
        ...
        <header>
            <div class="nav">
                ...
                <ul class="navigation">
                    <li><a href="acueil.php#acueil"> Acueil</a></li>
                    <li><a href="acueil.php#Modules"> module</a></li>
                    <li><a href="acueil.php#emploi"> Emploi du temp</a></li>
                    <li><a href="acueil.php#lien"> Liens de cours</a></li>
